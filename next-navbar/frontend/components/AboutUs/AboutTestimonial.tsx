...
const AboutTestimonial: React.FC = () => {
  ...
  return (
    <section
      className={`sec-padding overflow-x-hidden ${
    ...
    >
      <div className="flex justify-center items-center">
        {/* <Heading
          ...
          linewidth="25%"
        /> */}
        <h3 className="text-[#420516] ValkyRegular text-[30px] lg:text-[4.167vw] font-normal tracking-[0.167vw] capitalize">
          Testimonials
        </h3>
      </div>

      <div className="cust-container-13 m-auto h-full flex flex-col justify-center items-center testimonial-head exsc relative">
          ...
          >
            {testi.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="testi-card border-[#FFBB6D] border px-[4.448vw] sm:px-[2.448vw] py-[4.219vw] flex items-center justify-center">
                  <div className=" w-[100%] sm:w-[47.292vw] md:w-[100%] lg:w-[47.292vw]  height-[24.01vw]  flex-col ">
                    <div className="text-center commaa mb-[1.825vw]">
                      <svg
                        width="37"
                        height="29"
                        viewBox="0 0 37 29"
        ...
        <div className="w-full ">
          <div className="w-full flex justify-center items-center flex-row h-full ">
            <SwiperButton1
