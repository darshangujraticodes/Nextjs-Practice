...
const HeadingTwo: React.FC<HeadingProps> = ({ align, heading, subHeading, theme, linewidth }) => {
    return (
        <div
            className={`heading-section flex flex-col item-center`}
        >
            <h2 className={` heading-sub ValkyRegular tracking-wide ${theme === 'dark' ? 'text-[#fff]' : 'text-[#420516]'} text-${align ? align : 'start'}  w-full`}>{heading}</h2>
