...
const SwiperButton2: React.FC<SwiperButtonProps> = ({ next, prev }) => {
  return (
    <div className="swiper-nav text-center">
      <button
        className={`${prev} border-0 bg-[#FFBB6D] prev m-2 p-2 rounded-[50%]`}
      >
        <svg
      ...
      <button
        className={`${next} border-0 bg-[#FFBB6D] next m-2  p-2 rounded-[50%]`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
